...
if ($results) {
   ...
   print '<th>Fullname</th><th>NRIC</th><th>E-Mail</th><th>Tel No</th><th>Gender</th><th>Remarks</th>';
...
?>
Please enter the NRIC you want to edit
<form name="editform" action ="edit1.php" method="post">
<table>
<tr>
   <td>NRIC</td>
   <td><input type="text" name="NRIC" align="left"></td>
</tr>
<tr>
